...
export const allMetrics: MetricDefinition[] = [
  ...
  { key: 'appPixelResults', label: 'Pixel Results', shortLabel: 'Pixel Results', format: 'number', description: 'Pixel-attributed conversion events', category: 'conversions' },
  { key: 'appPixelPurchases', label: 'Pixel Purchases', shortLabel: 'Pixel Purch.', format: 'number', description: 'Pixel-attributed purchase count', category: 'conversions' },
  { key: 'appPixelPurchaseValue', label: 'Pixel Value', shortLabel: 'Pixel Value', format: 'currency', description: 'Pixel-attributed purchase revenue', category: 'financial' },
  { key: 'appPixelRoas', label: 'Pixel ROAS', shortLabel: 'Pixel ROAS', format: 'roas', description: 'Pixel revenue divided by Meta spend', category: 'performance' },
  { key: 'appPixelCpa', label: 'Pixel CPA', shortLabel: 'Pixel CPA', format: 'currency', description: 'Meta spend divided by Pixel purchases', category: 'conversions' },
...
export const defaultColumnPresets: ColumnPreset[] = [
  ...
  },
  {
    id: 'kill-list-view',
    name: 'Kill List',
    columns: ['roas', 'cpa', 'spend', 'conversions', 'frequency', 'cpm'],
    isDefault: true,
    isCustom: false,
  },
  {
    id: 'scale-view',
    name: 'Scale Now',
    columns: ['roas', 'revenue', 'spend', 'cpa', 'conversions', 'aov'],
    isDefault: true,
    isCustom: false,
  },
  {
    ...
    columns: ['roas', 'cpa', 'purchaseValue', 'aov', 'cvr', 'appPixelRoas', 'appPixelCpa'],
    isDefault: true,
    isCustom: false,
  },
  {
    ...
    columns: ['ctr', 'cpm', 'thumbstopRate', 'hookRate', 'frequency', 'reach'],
    isDefault: true,
    isCustom: false,
  },
  {
    id: 'bid-budget',
    name: 'Bid & Budget',
    columns: ['spend', 'roas', 'cpa', 'cpm', 'frequency', 'impressions'],
    isDefault: true,
    isCustom: false,
  },
  {
    id: 'full-analysis',
    name: 'Full Analysis',
    columns: ['spend', 'revenue', 'roas', 'cpa', 'conversions', 'ctr', 'cpm', 'frequency', 'aov', 'cvr'],
    isDefault: true,
    isCustom: false,
  },
];
